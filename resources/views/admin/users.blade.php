                  ...
                  <div class="col-12">
                    <div class="card card-default">
                      <div class="card-header">
                        ...
                        <a href="#" class="btn btn-primary btn-pill" data-toggle="modal" data-target="#modal-stock">Add User</a>
                      </div>
                      <div class="card-body">
                        {{-- ALERT SUCCESS --}}
                        @if (session('success'))
                          ...
                          <tbody>
                            @foreach ($users as $index => $user)
                              <tr>
                                ...
                                <td>
                                  @php
                                      $avatar = (!empty($user->ava) && file_exists(public_path('img/team/'.$user->ava)))
                                                ? $user->ava
                                                : 'Default.png';
                                  @endphp

                                  <img src="{{ asset('img/team/'.$avatar) }}" alt="Profile Image">
                                </td>
